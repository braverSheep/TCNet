...
if __name__ == '__main__':
    ...
    net = transformer(img_size=128, patch_size=2, embed_dim=64, num_class=4).to(device)
    ...
    optimizer = optim.SGD(net.parameters(), lr=0.0005, momentum=0.9)##0.0003
    ...
    for epoch in tqdm(range(100)):
        ...
        with torch.no_grad():
            ...
            if accurate_test > best_acc and f1_test > best_f1 :
                ...
                best_f1=f1_test
                torch.save(net.state_dict(), f'./savedmodel_transformer{best_acc}.pth')
